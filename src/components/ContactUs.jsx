...
function ContactUs() {
  return (
    <div className='w-full  h-screen px-2 sm:px-12 md:px-24 lg:px-40 py-20'>
      ...
      <div className='flex overflow-hidden flex-col justify-center items-center  text-center  gap-4 sm:gap-7 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-2xl w-full h-full'>
       <h1 className=' text-2xl sm:text-3xl px-1 md:text-4xl font-semibold '>{contact.h1}</h1>
